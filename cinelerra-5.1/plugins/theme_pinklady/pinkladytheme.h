...
#ifndef DEFAULTpinkladytheme_H
#define DEFAULTpinkladytheme_H
...
class PINKLADYMain : public PluginTClient
{
public:
	PINKLADYMain(PluginServer *server);
	~PINKLADYMain();
